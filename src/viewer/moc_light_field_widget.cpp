/****************************************************************************
** Meta object code from reading C++ file 'light_field_widget.h'
**
...
#error "The header file 'light_field_widget.h' doesn't include <QObject>."
...
void LightFieldWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LightFieldWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject LightFieldWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QOpenGLWidget::staticMetaObject>(),
    qt_meta_stringdata_LightFieldWidget.data,
    qt_meta_data_LightFieldWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
